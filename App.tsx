          ...
          >
            {categories.map((cat) => (
              <button
                ...
                className={`whitespace-nowrap text-[10px] tracking-[0.2em] font-black transition-all uppercase flex-shrink-0 snap-center px-5 py-2.5 rounded-full border transition-all duration-300 relative ${
                  activeCategory === cat 
